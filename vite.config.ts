...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Secure Authentication App',
        short_name: 'SecureAuth',
        description: 'Biometric authentication app with fingerprint and face login - like your banking app',
        theme_color: '#10b981',
      ...
      workbox: {
        ...
        runtimeCaching: [
          {
            urlPattern: /^https:\/\/savingwork\.onrender\.com\/api\/.*/i,
  ...
  build: {
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          vendor: ['react', 'react-dom', '@simplewebauthn/browser'],
          ui: ['lucide-react']
        }
      }
    }
